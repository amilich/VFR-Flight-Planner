...
class GoogleMapPlotter(object):
    ...
    def to_string(self):
        ...
        # string += '<title>Google Maps - pygmaps </title>\n'
        string += '<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?libraries=visualization&sensor=true_or_false"></script>\n'
        string += '<script type="text/javascript">\n'
        string += '\tfunction initialize() {\n'
        string += self.write_map2()
        string += self.write_grids2()
        string += self.write_points2()
        string += self.write_paths2()
        # self.write_shapes(f)
        # self.write_heatmap(f)
        string += '\t}\n'
        string += '</script>\n'
        string += '</div>\n'
        # string += '</head>\n'
        string += '<div style="margin:0px; padding:0px;" onload="initialize()">\n'
    ...
    def write_grids2(self):
        ...
        for line in self.grids:
            ...
            string += self.write_polyline2(line, settings)
        return string
    ...
    def write_points2(self):
        string = ""
        for point in self.points:
            string += self.write_point2(point[0], point[1], point[2], point[3])
        return string
    ...
    def write_paths2(self):
        string = ""
        for path, settings in self.paths:
            string += self.write_polyline2(path, settings)
        return string
    ...
    def write_point2(self, lat, lon, color, title):
        string = ""
    ...
    def write_polyline2(self, path, settings):
        clickable = False
        geodesic = True
